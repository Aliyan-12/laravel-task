...
@section('page-title', 'House Members/Edit')
@section('content')
<center>
    <h2 class="mb-5">{{sprintf('Edit House Member: %s', $member->name)}}</h2>
</center>
...
<form method="POST" action="{{route('member.update', ['id' => $member->id])}}">
    ...
    <div class="form-group mb-3">
        ...
        <input required type="name" value="{{$member->name}}" class="form-control" id="name" name="name">
    </div>
    <div class="form-group mb-3">
        <label for="email">Email</label>
        <input required type="email" value="{{$member->email}}" class="form-control" id="email" name="email">
    </div>
    <div class="form-group mb-3">
        <label for="cnic">CNIC</label>
        <input type="number" value="{{$member->cnic}}" class="form-control" id="cnic" name="cnic">
    </div>
    <div class="form-group mb-3">
        <label for="age">Age</label>
        <input type="number" value="{{$member->age}}" class="form-control" id="age" name="age">
    </div>
    <div class="form-group mb-3">
    ...
    <div class="form-group mb-3">
        ...
        <select required class="form-control" id="house_id" name="house_id">
            <option value="{{$member->getHouseId()}}">{{$member->getHouseNumber()}}</option>
        </select>
    </div>
    <div class="form-group mb-3">
        <label for="description">Description</label>
        <textarea class="form-control" value="{{$member->description}}" id="description" name="description" rows="3"></textarea>
    </div>
    <div class="form-group mb-3">
        <center>
